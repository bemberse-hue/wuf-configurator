    ...
    <div className="mt-10 pt-8 border-t border-ink/10 space-y-2">
      ...
      <div className="grid grid-cols-2 gap-3 mb-8">
        <div className="flex items-start gap-2.5 p-3 rounded-xl bg-oliva/[0.06]">
          ...
          <span className="text-[11px] font-medium leading-snug text-ink/70">Acero AISI 304, grado quirúrgico</span>
        </div>
        <div className="flex items-start gap-2.5 p-3 rounded-xl bg-oliva/[0.06]">
          <svg className="w-4 h-4 mt-0.5 shrink-0 text-oliva-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <span className="text-[11px] font-medium leading-snug text-ink/70">Fabricado bajo pedido en Bogotá</span>
        </div>
        <div className="flex items-start gap-2.5 p-3 rounded-xl bg-oliva/[0.06]">
          <svg className="w-4 h-4 mt-0.5 shrink-0 text-oliva-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75M3.75 4.5h16.5v15H3.75v-15z" />
          </svg>
          <span className="text-[11px] font-medium leading-snug text-ink/70">Ortografía confirmada antes de producir</span>
        </div>
        <div className="flex items-start gap-2.5 p-3 rounded-xl bg-oliva/[0.06]">
          <svg className="w-4 h-4 mt-0.5 shrink-0 text-oliva-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
      ...
      <details className="group [&_summary::-webkit-details-marker]:hidden">
        ...
        <div className="py-4 text-sm font-light text-ink/60 leading-relaxed">
          <ul className="space-y-3">
            ...
            <li className="grid grid-cols-3 gap-4 border-b border-ink/5 pb-2"><strong className="col-span-1 font-bold text-xs uppercase text-ink/90">Inserto</strong><span className="col-span-2">Acero Inox AISI 304 (Grado quirúrgico). Ø 14.0 cm ext. (Profundidad: 4.5 cm)</span></li>
            ...
            <li className="grid grid-cols-3 gap-4 border-b border-ink/5 pb-2"><strong className="col-span-1 font-bold text-xs uppercase text-ink/90">Estructura</strong><span className="col-span-2">Polímero técnico PLA Matte de origen vegetal de alta densidad</span></li>
      ...
      <details className="group [&_summary::-webkit-details-marker]:hidden">
        <summary className="flex cursor-pointer items-center justify-between py-4 border-b border-ink/10 text-xs font-black tracking-widest uppercase text-ink hover:text-ink/60 transition-colors">
          <span>Higiene médica sin fricción</span>
          <span className="transition-transform group-open:rotate-180">
            <svg fill="none" height="20" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" width="20"><path d="M6 9l6 6 6-6"></path></svg>
          </span>
        </summary>
        <div className="py-4 text-sm font-light text-ink/60 leading-relaxed space-y-4">
          ...
          <div>
            <strong className="block font-bold text-xs uppercase text-ink/90 mb-1">El Pedestal Escultórico (Base Mate)</strong>
            <ul className="list-disc pl-4 space-y-1">
      ...
      <details className="group [&_summary::-webkit-details-marker]:hidden">
        ...
        <div className="py-4 text-sm font-light text-ink/60 leading-relaxed space-y-4">
          ...
          <div>
            ...
            <p>Despachamos desde Bogotá a toda Colombia. El envío se calcula según la ciudad ($10.000 a $15.000 COP promedio).</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>Ofrecemos 2 meses de garantía directa por defectos de fabricación estructurales.</p>
          </div>
        </div>
      </details>
